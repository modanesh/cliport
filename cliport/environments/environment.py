...
class HelpEnvWrapper(Environment):
    def __init__(self, assets_root, weak_policy, strong_policy, timeout, strong_query_cost, switching_agent_cost, obs_type, device,
                 task=None, disp=False, shared_memory=False, hz=240):
        ...
        self.strong_query_cost = strong_query_cost
        self.switching_agent_cost = switching_agent_cost
        self.strong_query_cost_per_action = (0 / self.timeout) * self.strong_query_cost
        self.switching_agent_cost_per_action = (0 / self.timeout) * self.switching_agent_cost
        self.action = None
    ...
    def set_costs(self, reward_max):
        ...
        self.switching_agent_cost_per_action = (reward_max / self.timeout) * self.switching_agent_cost
